...
class Stage11RegistryTests(unittest.TestCase):
    def test_canonical_stage11_and_frozen_stage10_projection(self) -> None:
        ...
        self.assertEqual((registry.schema_version, registry.registry_version), ("1.9.0", "2.49.0"))
        self.assertEqual((len(registry.migrations), len(registry.datasets), len(registry.collectors)), (40, 53, 54))
