...
def _validate_top_level(raw: Any) -> Mapping[str, Any]:
    ...
    if (
        ...
        or raw["registry_version"] not in {"2.67.0", "2.68.0", "2.69.0", "2.70.0", "2.71.0", "2.72.0", "2.73.0", "2.74.0", "2.75.0", "2.76.0", "2.77.0", "2.78.0", "2.79.0", "2.80.0", "2.81.0", "2.82.0", "2.83.0", "2.84.0", "2.85.0", "2.86.0", "2.87.0", "2.88.0", "2.89.0", "2.90.0", "2.91.0", "2.92.0"}
...
def stage2_registry_profile(registry: Registry) -> Registry:
    ...
    payload = (
        json.dumps(
            registry.raw,
            ensure_ascii=True,
            indent=1 if (registry.schema_version, registry.registry_version) in {("1.9.0", "2.72.0"), ("1.9.0", "2.73.0"), ("1.9.0", "2.74.0"), ("1.9.0", "2.75.0"), ("1.9.0", "2.76.0"), ("1.9.0", "2.77.0"), ("1.9.0", "2.78.0"), ("1.9.0", "2.79.0"), ("1.9.0", "2.80.0"), ("1.9.0", "2.81.0"), ("1.9.0", "2.82.0"), ("1.9.0", "2.83.0"), ("1.9.0", "2.84.0"), ("1.9.0", "2.85.0"), ("1.9.0", "2.86.0"), ("1.9.0", "2.87.0"), ("1.9.0", "2.88.0"), ("1.9.0", "2.89.0"), ("1.9.0", "2.90.0"), ("1.9.0", "2.91.0"), ("1.9.0", "2.92.0")} else 2,
            sort_keys=True,
        )
        + "\n"
    ).encode("utf-8")
